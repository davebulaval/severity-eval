...
def classify_severity(
    ...
    # ---- critical ----
    if (scale == "billion" and answer_type == "arithmetic") or (
        scale == "million" and answer_type == "arithmetic" and is_core
    ):
        severity = "critical"
    ...
    # ---- major ----
        ...
        severity = "major"
    elif (scale == "million" and answer_type in ("arithmetic", "count")) or (
        scale == "million" and is_core
    ):
        severity = "major"
    ...
    # ---- minor ----
        ...
        severity = "minor"
    elif (answer_type in ("count", "multi-span") and is_numeric) or (
        answer_type == "span" and is_numeric
    ):
        severity = "minor"
...
def load_tatqa(
    ...
    try:
        ...
        raise RuntimeError(
            f"Failed to download TAT-QA {split} split from {url}: {exc}"
        ) from exc
