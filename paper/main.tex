...
crossing lines visualise the $138$ inversions surfaced by RQ1.}
...
(marginally) frequency-driven. Figure~\ref{fig:profiles_insurance}
shows that the insurance domain's $\bpi$ varies widely across
models, which explains the highest $\sigma^2_{\bpi}/\sigma^2$
ratio. The decomposition is sensitive to the cost vector and to the
model
