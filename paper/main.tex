...
(Section~\ref{sec:library}). The analysis is organised around five
research questions probing accuracy vs.\ actuarial risk, with a
quantitative criterion per question summarising the empirical signal.
...
and risk tolerance. The RQ5 robustness analysis tests whether
