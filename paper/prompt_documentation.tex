...
We evaluate up to 29 LLMs across eight datasets spanning four domains (finance, medical, legal, insurance) after dropping three benchmarks (MedQA, MedCalc-Bench, RAG Insurance) whose keyword-based severity labels could not be defended at the critical-vs-major boundary in inter-annotator validation.
...
% ---------------------------------------------------------------------------
\subsection{Severity Annotation Recap}
\label{sec:app-severity-annotation-recap}
% ---------------------------------------------------------------------------
